@extends('layouts.main', ['active' => 'transitions.one'])


{{-- Page Title --}}
@section('page-title', 'Transitions One')
...
@section('content')
  ...
  <p class="lead">
    <h2>One <small>/transitions/one</small></h2>
  </p>

  <div class="row">
    <div class="col-xs-12">
      <a href="{{ trlink('./two') }}" class="btn btn-block btn-default btn-lg">Next page</a>
      <br>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-xs-6">
      <img width="100%" src="/images/photo23.jpg">
    </div>
    <div class="col-xs-3"></div>
  </div>
  ...
  <div class="row">
    <div class="col-xs-3"></div>
    <div class="col-xs-6">
      <img width="100%" src="/images/photo24.jpg">
    </div>
    <div class="col-xs-3"></div>
  </div>
